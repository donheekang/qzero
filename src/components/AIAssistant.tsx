    ...
    <div className={compact ? "" : "mb-6"}>
      ...
      <div className="relative mb-3">
        <textarea
          ...
          rows={2}
          className="w-full px-4 py-3 bg-white border border-gray-200 rounded-2xl text-sm text-gray-900 placeholder-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-[#00E59B]/30 focus:border-[#00E59B] transition-all"
          onKeyDown={(e) => {
      ...
      {/* Result */}
      {result && (
        <div className="mt-3 bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-200 overflow-hidden">
          {/* Result header */}
          <div className="flex items-center justify-between px-4 py-2.5 border-b border-gray-100">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-gray-600">Q헬퍼 답변</span>
            </div>
            <button
              onClick={handleCopy}
